...
local_cluster = ClusterNode("127.0.0.1", 6001, "Peer1", "Client1", 0)
cluster2 = ClusterNode("127.0.0.1", 6002, "Peer2", "Client2", 0)
cluster3 = ClusterNode("127.0.0.1", 6003, "Peer3", "Client3", 0)
cluster4 = ClusterNode("127.0.0.1", 6004, "Peer4", "Client4", 0)
