...
local_cluster = ClusterNode("127.0.0.1", 6004, "Peer4", "Client4")
cluster5 = ClusterNode("127.0.0.1", 6005, "Peer5", "Client5")

# Lista de nós do cluster
cluster_nodes = [cluster1, cluster2, cluster3, cluster5]
...
if __name__ == "__main__":
    node_id = "Peer4"  
    threading.Thread(target=node_server, args=("127.0.0.1", 5004, node_id)).start()
    threading.Thread(target=cluster_sync_server, args=("127.0.0.1", 6004, node_id)).start()
