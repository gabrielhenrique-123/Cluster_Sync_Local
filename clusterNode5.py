...
local_cluster = ClusterNode("127.0.0.1", 6005, "Peer5", "Client5")

# Lista de nós do cluster
cluster_nodes = [cluster1, cluster2, cluster3, cluster4]
...
if __name__ == "__main__":
    node_id = "Peer5"  
    threading.Thread(target=node_server, args=("127.0.0.1", 5005, node_id)).start()
    threading.Thread(target=cluster_sync_server, args=("127.0.0.1", 6005, node_id)).start()
