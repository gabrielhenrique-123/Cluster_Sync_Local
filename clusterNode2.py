...
local_cluster = ClusterNode("127.0.0.1", 6002, "Peer2", "Client2")
...
cluster_nodes = [cluster1, cluster3, cluster4, cluster5]
...
if __name__ == "__main__":
    node_id = "Peer2"  
    threading.Thread(target=node_server, args=("127.0.0.1", 5002, node_id)).start()
    threading.Thread(target=cluster_sync_server, args=("127.0.0.1", 6002, node_id)).start()
